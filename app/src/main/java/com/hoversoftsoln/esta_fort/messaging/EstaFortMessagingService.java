...
public class EstaFortMessagingService extends FirebaseMessagingService {

    private static final String TAG = EstaFortMessagingService.class.getSimpleName();
    ...
    private void sendDataNotification(Map<String, String> remoteMessage) {
        ...
        NotificationCompat.Builder notificationBuilder =
                new NotificationCompat.Builder(this, channelId)
                        .setSmallIcon(R.drawable.ic_stat_ic_notification)
                        .setContentTitle("New Message from " + remoteMessage.get("sender"))
                        .setContentText(remoteMessage.get("subject"))
                        .setStyle(new NotificationCompat.BigTextStyle().bigText(remoteMessage.get("message")))
                        .setAutoCancel(true)
                        .setSound(defaultSoundUri)
                        .setContentIntent(pendingIntent);
